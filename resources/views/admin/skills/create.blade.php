                ...
                <form action="{{ route('skills.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="range" class="form-range" id="percentage" name="percentage" 
                               min="0" max="100" value="{{ old('percentage', 50) }}"
                               oninput="updatePercentageValue(this.value)">
                        <div class="text-center mt-2">
                            <span id="percentageValue" class="fw-bold text-primary">{{ old('percentage', 50) }}%</span>
                        </div>
                        @error('percentage')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-select" id="category" name="category" required>
                            ...
                            <option value="DevOps" {{ old('category') == 'DevOps' ? 'selected' : '' }}>DevOps & Tools</option>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" class="form-control" id="sort_order" name="sort_order" 
                               value="{{ old('sort_order', 0) }}" min="0" max="100"
